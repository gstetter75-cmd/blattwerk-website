...
export const historyArticles: readonly KnowledgeArticle[] = [
  {
    slug: 'cannabis-geschichte-weltweit',
    category: 'history',
    title_de: 'Die Geschichte von Cannabis: 5.000 Jahre Nutzung',
    title_en: 'The History of Cannabis: 5,000 Years of Use',
    summary_de:
...
The history of cannabis is a history of contradictions. The same plant revered in ancient cultures as a healing agent and spiritual companion became a projection screen for racist politics and moral panic in the 20th century. The current legalization movement is less a revolution than a return to a normalized relationship with a plant that has accompanied humanity for millennia. The challenge of the present is to learn from the mistakes of prohibition and create a regulatory framework that considers both individual freedom and public health and youth protection.`,
    tags: ['Geschichte', 'Prohibition', 'Legalisierung', 'Antike', 'Kulturgeschichte', 'UN-Konventionen'],
    reading_time: 18,
    last_updated: '2026-03-26',
    related_slugs: ['legalisierung-deutschland', 'cannabis-kultur-gesellschaft', 'kcang-ueberblick'],
  },

  {
    slug: 'legalisierung-deutschland',
    category: 'history',
    title_de: 'Der Weg zur Legalisierung in Deutschland',
    title_en: 'The Road to Legalization in Germany',
    summary_de:
...
The road to cannabis legalization in Germany was long, contested and marked by compromises. The KCanG is neither the full legalization that supporters had hoped for nor the catastrophe that opponents prophesied. It is a pragmatic middle path that decriminalizes and regulates private cannabis use without creating a commercial market. The legally mandated evaluation by 2028 will determine whether Germany expands, maintains or restricts this model. What is already clear: after decades of prohibition, Germany has changed course, with societal effects reaching far beyond the question of cannabis consumption itself.`,
    tags: ['Legalisierung', 'KCanG', 'BtMG', 'Deutschland', 'Cannabis Social Clubs', 'Politik', 'Koalitionsvertrag'],
    reading_time: 20,
    last_updated: '2026-03-26',
    related_slugs: ['cannabis-geschichte-weltweit', 'kcang-ueberblick', 'cannabis-social-clubs', 'medizinisches-cannabis-deutschland'],
  },

  {
    slug: 'cannabis-kultur-gesellschaft',
    category: 'history',
    title_de: 'Cannabis in Kultur und Gesellschaft',
    title_en: 'Cannabis in Culture and Society',
    summary_de:
    ...
    content_de: `Cannabis ist weit mehr als eine Pflanze oder ein Rauschmittel – es ist ein kulturelles Phänomen, das Musik, Film, Literatur, Kunst und gesellschaftliche Bewegungen über Generationen hinweg geprägt hat. Die Kulturgeschichte von Cannabis ist zugleich eine Geschichte von Kreativität und Rebellion, von Stigmatisierung und Emanzipation, von Subkultur und Mainstream. Dieser Artikel beleuchtet die vielfältigen Schnittstellen zwischen Cannabis und Kultur und zeichnet den Wandel der gesellschaftlichen Wahrnehmung nach.
...
The current trend toward destigmatization and normalization is not irreversible. It depends on whether legalization is accompanied by responsible education, whether the risks of consumption are communicated openly and whether youth protection is taken seriously. The cultural integration of cannabis into the social mainstream succeeds when cannabis is treated neither as something to glorify nor to demonize, but with factual differentiation – as what it is: a plant with a long history and a complex spectrum of effects.`,
    tags: ['Kultur', 'Musik', 'Film', 'Literatur', 'Kunst', 'Stigmatisierung', 'Entstigmatisierung', 'Gesellschaft'],
    reading_time: 18,
    last_updated: '2026-03-26',
